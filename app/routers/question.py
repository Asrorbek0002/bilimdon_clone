...
async  def create_question(question: QuestionCreate, db: db_dep, current_user: current_user_dep):
...
async def update_question(id: int, question: QuestionUpdate, db: db_dep):
...
async def delete_question(id: int, db: db_dep):
    ...
    return {"question_id": id, "message": "Question deleted"}
